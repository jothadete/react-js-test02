...
export default function App() {
  return (
    <div>
      ...
      <p>Neues Repository in Github angelegt und gepushed. Ende in StackBlitz.</p>
      <h2>VSCode</h2>
      <p>Geclont von GitHub, dabei neuen leeren Folder angelegt.</p>
      <p>Im Terminal npm install, um die Bibliotheken in das Verzeichnis zu laden. Dies git-ignored.</p>
      <p>npm start - funktioniert soweit.</p>
      <p>commit changes - push to GitHub. Ende in VSCode</p>
      <h2>StackBlitz 2</h2>
